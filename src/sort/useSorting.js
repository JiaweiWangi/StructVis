...
export function useSorting() {
  ...
  return {
    ...
    generateRandomArray,
    // 排序触发函数 (使用包装器封装)
    runBubbleSort: () => runSortAlgorithm(bubbleSort),
    runSelectionSort: () => runSortAlgorithm(selectionSort),
    runInsertionSort: () => runSortAlgorithm(insertionSort),
    runQuickSort: () => runSortAlgorithm(quickSort),
  };
}